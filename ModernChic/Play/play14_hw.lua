...
local header = {
	type = 2,			-- 0:7k, 1:5k, 2:14k, 3:10k, 4:9k, 5:select, 6:decide, 7:result, 15:courceresult, 16:24k, 17:24kDouble
...
--[[
	...
	do
		...
		local keyRightPosX = {3, 66, 117, 180, 231, 294, 345, 408}
		...
		skin.note = {
			...
			dst = {
				...
				-- L6鍵
				{x = laneLeftPosX + keyLeftPosX[6], y = notesPositionY - 12, w = blueWidth, h = 857},
				-- L7鍵
				{x = laneLeftPosX + keyLeftPosX[7], y = notesPositionY - 12, w = whiteWidth, h = 857},
				-- L皿
				{x = laneLeftPosX + keyLeftPosX[8], y = notesPositionY - 12, w = scWidth, h = 857},
				-- R1鍵
				...
				-- R6鍵
				{x = laneRightPosX + keyRightPosX[6], y = notesPositionY - 12, w = blueWidth, h = 857},
				-- R7鍵
				{x = laneRightPosX + keyRightPosX[7], y = notesPositionY - 12, w = whiteWidth, h = 857},
				-- R皿
				{x = laneRightPosX + keyRightPosX[8], y = notesPositionY - 12, w = scWidth, h = 857},
			},
	...
	do
		local information = {
			flashLeftTimer = {101, 102, 103, 104, 105, 106, 107},
			flashRightTimer = {111, 112, 113, 114, 115, 116, 117},
			flashLeftPosX = {110, 167, 224, 281, 338, 395, 452},
			flashRightPosX = {-1, 56, 113, 170, 227, 284, 341},
			num = 7,
		}
	...
	-- キー入力
	do
		local inputkey7_path = skin_config.get_path("lua/dp/inputkey14.lua")
	...
	do
		...
		local prepare_status, prepare_parts = pcall(function()
			return dofile(prepare_path).load(laneLeftPosX, laneRightPosX, notesPositionY)
		end)
	...
	-- 爆発
	do
		local bomb7_path = skin_config.get_path("lua/dp/bomb14.lua")
