function img_notes_key_1p_v074(var)
	...
	for i = 1, var do
		...
		table.insert(img, {id = "hcnr-" .. i, src = "src-notes-" .. i, x = 0, y = 272, w = 128, h = 24, divy = 2, cycle = 100})	-- ヘルチャージノートダメージ
		table.insert(img, {id = "hcnd-" .. i, src = "src-notes-" .. i, x = 0, y = 248, w = 128, h = 24, divy = 2, cycle = 266})	-- ヘルチャージノートリアクティブ
...
function img_notes_scratch_1p_v074()
	...
	table.insert(img, {id = "hcnr-s", src = "src-notes-s", x = 0, y = 272, w = 128, h = 24, divy = 2, cycle = 100})	-- ヘルチャージノートダメージ
	table.insert(img, {id = "hcnd-s", src = "src-notes-s", x = 0, y = 248, w = 128, h = 24, divy = 2, cycle = 266})	-- ヘルチャージノートリアクティブ
