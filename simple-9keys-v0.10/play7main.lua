...
function main()
	...
	local header = {
		...
		property = {
			...
			--]]
			{name = op_consts.OP_1_NAME, item = {
				{name = op_consts.OP_1_ITEM_NAME_1, op = op_consts.OP_1_ITEM_NUMBER_1},
				{name = op_consts.OP_1_ITEM_NAME_2, op = op_consts.OP_1_ITEM_NUMBER_2},
				{name = op_consts.OP_1_ITEM_NAME_3, op = op_consts.OP_1_ITEM_NUMBER_3},
				{name = op_consts.OP_1_ITEM_NAME_4, op = op_consts.OP_1_ITEM_NUMBER_4},
				{name = op_consts.OP_1_ITEM_NAME_5, op = op_consts.OP_1_ITEM_NUMBER_5},
				{name = op_consts.OP_1_ITEM_NAME_6, op = op_consts.OP_1_ITEM_NUMBER_6},
				{name = op_consts.OP_1_ITEM_NAME_7, op = op_consts.OP_1_ITEM_NUMBER_7},
				{name = op_consts.OP_1_ITEM_NAME_8, op = op_consts.OP_1_ITEM_NUMBER_8}
			}},
		...
		filepath = {
			...
			{name = "1レーン目の色 Lane Color Key1",					path = "customize/lanecolor/*.png|1|", def = "02_lampblack.png"},
			{name = "2レーン目の色 Lane Color Key2",					path = "customize/lanecolor/*.png|2|", def = "01_black.png"},
			{name = "3レーン目の色 Lane Color Key3",					path = "customize/lanecolor/*.png|3|", def = "02_lampblack.png"},
			{name = "4レーン目の色 Lane Color Key4",					path = "customize/lanecolor/*.png|4|", def = "01_black.png"},
			{name = "5レーン目の色 Lane Color Key5",					path = "customize/lanecolor/*.png|5|", def = "02_lampblack.png"},
			{name = "6レーン目の色 Lane Color Key6",					path = "customize/lanecolor/*.png|6|", def = "01_black.png"},
			{name = "7レーン目の色 Lane Color Key7",					path = "customize/lanecolor/*.png|7|", def = "02_lampblack.png"},
			{name = "スクラッチレーンの色 Lane Color Scratch",			path = "customize/lanecolor/*.png|8|", def = "01_black.png"},
			{name = "レーン間の線の色 Lane Line Color",					path = "customize/lanecolor/*.png|9|", def = "03_grey.png"},
			{name = "レーンの外枠の色 Lane Outline Color",				path = "customize/lanecolor/*.png|10|", def = "04_silver.png"},
		...
		offset = {
			...
			{name = offset_consts.PARAMETER_9_NAME,		id = offset_consts.PARAMETER_9_ID,	w = true},
			...
			{name = offset_consts.PARAMETER_50_NAME,	id = offset_consts.PARAMETER_50_ID,	w = true, h = true},
			...
			{name = offset_consts.PARAMETER_34_NAME,	id = offset_consts.PARAMETER_34_ID,	x = true, y = true},
			{name = offset_consts.PARAMETER_35_NAME,	id = offset_consts.PARAMETER_35_ID,	w = true, h = true},
	...
	local function body()
		...
		-- 各レーン幅
		local lane_width = {75, 59, 75, 59, 75, 59, 75, 101}
		...
		if skin_config.offset[offset_consts.PARAMETER_9_NAME].w > 0 then
			lane_width[8] = skin_config.offset[offset_consts.PARAMETER_9_NAME].w
		end 
		
		-- 各ノーツ幅
		local note_width = {}
		local note_height = {40,40,40,40,40,40,40,40}
		...
		if skin_config.offset[offset_consts.PARAMETER_50_NAME].w > 0 then
			note_width[8] = skin_config.offset[offset_consts.PARAMETER_50_NAME].w
		end 
		...
		if skin_config.offset[offset_consts.PARAMETER_50_NAME].h > 0 then
			note_height[8] = skin_config.offset[offset_consts.PARAMETER_50_NAME].h
		end 

		-- レーン間の線幅
		local lane_line_px = 1
		...
		-- レーンの座標
		local lane_origin_x = 20 + lane_outline_px
		...
		local songprogress_height = lane_height - 40
		...
		local songprogress_x = lane_origin_x - lane_outline_px - 14
		...
		local songprogress_y = lane_origin_y + 20
		...
		local keybeam_width = {
			...
			s = lane_width[8] - (keybeam_variable * 2)
		}
		...
		-- ボムのy座標
		local bomb_y = lane_origin_y - (bomb_size.h / 2)
		...
		-- OADXボムのy座標
		local oadx_bomb_y = lane_origin_y - (oadx_bomb_size.h / 2) - (oadx_bomb_size.h / 100 * 7.29166666666667)
		
		-- ターンテーブルの位置を設定する
		local function op_turntable_position(var)
			local position = nil
			local switch = {}
			switch[op_consts.OP_1_ITEM_NUMBER_1] = function()
				position = 1
			end
			switch[op_consts.OP_1_ITEM_NUMBER_2] = function()
				position = 2
			end
			switch[op_consts.OP_1_ITEM_NUMBER_3] = function()
				position = 3
			end
			switch[op_consts.OP_1_ITEM_NUMBER_4] = function()
				position = 4
			end
			switch[op_consts.OP_1_ITEM_NUMBER_5] = function()
				position = 5
			end
			switch[op_consts.OP_1_ITEM_NUMBER_6] = function()
				position = 6
			end
			switch[op_consts.OP_1_ITEM_NUMBER_7] = function()
				position = 7
			end
			switch[op_consts.OP_1_ITEM_NUMBER_8] = function()
				position = 8
			end
			switch[var]()
			return position
		end
		local turntable_position = op_turntable_position(skin_config.option[op_consts.OP_1_NAME])
		...
		do
			local lane_order = {1, 2, 3, 4, 5, 6, 7}
			table.insert(lane_order, turntable_position, 8)
		...
		-- ジャッジの座標
		local judge_x = lane_center_x - 90
		local judge_y = lane_origin_y + 160
		
		if skin_config.option[op_consts.OP_6_NAME] == op_consts.OP_6_ITEM_NUMBER_2 then
			judge_x = lane_center_x - 145
		end
		
		local judgedetail_x = judge_x +18
		local judgedetail_y = judge_y + 100
		local ghost_x = judge_x + 126
		local ghost_y = judge_y + 100
			
		-- スコアグラフの座標
		local graph_x = lane_right_x + 6
		...
		-- マスコットの座標
		local mascot_x = graph_x + 52
		if skin_config.offset[offset_consts.PARAMETER_37_NAME].x ~= 0 then
			mascot_x = skin_config.offset[offset_consts.PARAMETER_37_NAME].x
		end	
		local mascot_y = graph_y + 3
		if skin_config.offset[offset_consts.PARAMETER_37_NAME].y ~= 0 then
			mascot_y = skin_config.offset[offset_consts.PARAMETER_37_NAME].y
		end	
		...
		local gauge_width = (12 * gauge_scale)
		...
		-- BGA
		local bga_x = 840
		if skin_config.offset[offset_consts.PARAMETER_34_NAME].x ~= 0 then
			bga_x = skin_config.offset[offset_consts.PARAMETER_34_NAME].x
		end	
		local bga_y = 0
		if skin_config.offset[offset_consts.PARAMETER_34_NAME].y ~= 0 then
			bga_y = skin_config.offset[offset_consts.PARAMETER_34_NAME].y
		end	
		local bga_width = 1080
		if skin_config.offset[offset_consts.PARAMETER_35_NAME].w ~= 0 then
			bga_width = skin_config.offset[offset_consts.PARAMETER_35_NAME].w
		end	
		local bga_height = 1080
		if skin_config.offset[offset_consts.PARAMETER_35_NAME].h ~= 0 then
			bga_height = skin_config.offset[offset_consts.PARAMETER_35_NAME].h
		end	
		local bga_opacity = 0
		...
		append_all(skin.image, img_bomb_key_1p(7))
		append_all(skin.image, img_bomb_scratch_1p())
		---[[ バグ対応
		if skin_config.option[op_consts.OP_0_NAME] == op_consts.OP_0_ITEM_NUMBER_2 then
			append_all(skin.image, img_notes_key_1p(7))
			append_all(skin.image, img_notes_scratch_1p())
		else
			append_all(skin.image, img_notes_key_1p_v074(7))
			append_all(skin.image, img_notes_scratch_1p_v074())
		end
		--]]
		...
		if skin_config.option[op_consts.OP_6_NAME] == op_consts.OP_6_ITEM_NUMBER_1 then
			skin.judge = {
			{
				...
				index = 0,
				images = {
					{id = "judgef-pg", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}},
					{id = "judgef-gr", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}},
					{id = "judgef-gd", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}},
					{id = "judgef-bd", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}},
					{id = "judgef-pr", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}},
					{id = "judgef-ms", loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 180, h = 50},{time = 500}}}
				},
				numbers = {
					{id = "judgen-pg", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}},
					{id = "judgen-gr", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}},
					{id = "judgen-gd", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}},
					{id = "judgen-bd", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}},
					{id = "judgen-pr", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}},
					{id = "judgen-ms", loop = -1, timer = 46, dst = {{time = 0, x = 216, y = 0, w = 36, h = 50},{time = 500}}}
				},
				shift = true
			}}
		elseif skin_config.option[op_consts.OP_6_NAME] == op_consts.OP_6_ITEM_NUMBER_2 then
			skin.judge = {
			{
				...
				index = 0,
				images = {
					{id = "oadx+-judgef-pg", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}},
					{id = "oadx+-judgef-gr", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}},
					{id = "oadx+-judgef-gd", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}},
					{id = "oadx+-judgef-bd", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}},
					{id = "oadx+-judgef-pr", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}},
					{id = "oadx+-judgef-ms", filter = 1, loop = -1, timer = 46 ,offsets = {3,32}, dst = {{time = 0, x = judge_x, y = judge_y, w = 231, h = 79},{time = 500}}}
				},
				numbers = {
					{id = "oadx+-judgen-pg", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}},
					{id = "oadx+-judgen-gr", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}},
					{id = "oadx+-judgen-gd", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}},
					{id = "oadx+-judgen-bd", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}},
					{id = "oadx+-judgen-pr", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}},
					{id = "oadx+-judgen-ms", filter = 1, loop = -1, timer = 46, dst = {{time = 0, x = 240, y = 0, w = 51, h = 79},{time = 500}}}
				},
				shift = true
			}}
		end
		...
		skin.destination = {
			...
			{id = "bga", op = {op_consts.DISP_12_NUMBER_2}, stretch = 1, dst = {{x = bga_x, y = bga_y, w = bga_width, h = bga_height, a = 255 + bga_opacity}}},
			{id = "no-bga-image", timer = 41, op = {170,op_consts.DISP_12_NUMBER_2}, stretch = 1, dst = {{x = bga_x, y = bga_y, w = bga_width, h = bga_height, a = 255 + bga_opacity}}},
			...
			{id = "song-progress-bg", dst = {{x = songprogress_x, y = songprogress_y, w = songprogress_width, h = songprogress_height, a = 64}}},
			...
			{id = "lane-s", dst = {{x = lane_x[8], y = lane_origin_y, w = lane_width[8], h = lane_height, a = 255 + lane_opacity}}},
			...
			{id = "key", timer = 100, dst = {{x = keybeam_x[8], y = lane_origin_y - lane_outline_px - 90, w = keybeam_width.s, h = 80}}},
			
			{id = "keybeam1", timer = 101, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[1], y = lane_origin_y, w = lane_width[1], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam2", timer = 102, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[2], y = lane_origin_y, w = lane_width[2], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam3", timer = 103, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[3], y = lane_origin_y, w = lane_width[3], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam4", timer = 104, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[4], y = lane_origin_y, w = lane_width[4], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam5", timer = 105, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[5], y = lane_origin_y, w = lane_width[5], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam6", timer = 106, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[6], y = lane_origin_y, w = lane_width[6], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam7", timer = 107, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_x[7], y = lane_origin_y, w = lane_width[7], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeam1", timer = 121, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[1], y = lane_origin_y, w = lane_width[1], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[1], w = keybeam_width.key1, a = 0}}},
			{id = "keybeam2", timer = 122, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[2], y = lane_origin_y, w = lane_width[2], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[2], w = keybeam_width.key2, a = 0}}},
			{id = "keybeam3", timer = 123, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[3], y = lane_origin_y, w = lane_width[3], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[3], w = keybeam_width.key3, a = 0}}},
			{id = "keybeam4", timer = 124, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[4], y = lane_origin_y, w = lane_width[4], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[4], w = keybeam_width.key4, a = 0}}},
			{id = "keybeam5", timer = 125, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[5], y = lane_origin_y, w = lane_width[5], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[5], w = keybeam_width.key5, a = 0}}},
			{id = "keybeam6", timer = 126, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[6], y = lane_origin_y, w = lane_width[6], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[6], w = keybeam_width.key6, a = 0}}},
			{id = "keybeam7", timer = 127, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{time = 0, x = lane_x[7], y = lane_origin_y, w = lane_width[7], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[7], w = keybeam_width.key7, a = 0}}},
		
			{id = "keybeams", timer = 100, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_2_ITEM_NUMBER_1}, dst = {{x = lane_x[8], y = lane_origin_y, w = lane_width[8], h = keybeam_height, a = 255 + keybeam_opacity}}},
			{id = "keybeams", timer = 120, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_2_ITEM_NUMBER_1}, dst = {{time = 0, x = lane_x[8], y = lane_origin_y, w = lane_width[8], h = keybeam_height, a = 255 + keybeam_opacity},{time = 40, x = keybeam_x[8], w = keybeam_width.s, a = 0}}},

			{id = "keybeams", timer = 100, loop = -1, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_2_ITEM_NUMBER_2}, dst = {{time = 0, x = lane_x[8], y = lane_origin_y, w = lane_width[8], h = keybeam_height, a = 255 + keybeam_opacity},{time = 50},{time = 90, x = keybeam_x[8], w = keybeam_width.s, a = 0}}},
			
			{id = "glow", timer = 40, loop = 500, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, blend = 2,	dst = {{time = 0, x = lane_origin_x, y = lane_origin_y, w = lane_width_total, h = glow_height, a = 0},{time = 500, a = 64}}},
			{id = "glow", timer = 140, loop = 0, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, blend = 2,		dst = {{time = 0, x = lane_origin_x, y = lane_origin_y, w = lane_width_total, h = glow_height, a = 255},{time = 1000, a = 0}}},
			
			{id = "judgeline", timer = 40, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_origin_x, y = lane_origin_y, w = lane_width_total, h = judgeline_height}}},
			{id = "load-progress", offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {80}, dst = {{x = lane_origin_x, y = lane_origin_y, w = lane_width_total, h = judgeline_height}}},

			{id = "liftcover", stretch = 3, offsets = {offset_consts.OFFSET_1_ID}, dst = {{x = lane_origin_x, y = lane_origin_y - lane_height, w = lane_width_total, h = lane_height}}},
			...
			{id = "bombs", timer = 50, loop = -1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_1}, dst = {{time = 0, x = bomb_x[8], y = bomb_y, w = bomb_size.w, h = bomb_size.h},{time = 250}}},
			...
			{id = "holds", timer = 70, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_1}, dst = {{time = 0, x = bomb_x[8], y = bomb_y, w = bomb_size.w, h = bomb_size.h}}},
			...
			{id = "holds-b", timer = 70, loop = -1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_1}, dst = {{time = 0, x = bomb_x[8], y = bomb_y, w = bomb_size.w, h = bomb_size.h},{time = 250}}},
			...
			{id = "oadxbombs", timer = 50, filter = 1, loop = -1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_2}, dst = {{time = 0, x = oadx_bomb_x[8], y = oadx_bomb_y, w = oadx_bomb_size.w, h = oadx_bomb_size.h},{time = 250}}},
			...
			{id = "oadxholds", timer = 70, filter = 1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_2}, dst = {{time = 0, x = oadx_bomb_x[8], y = oadx_bomb_y, w = oadx_bomb_size.w, h = oadx_bomb_size.h}}},
			...
			{id = "oadxbombs", timer = 50, filter = 1, loop = -1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_3}, dst = {{time = 0, x = oadx_bomb_x[8], y = oadx_bomb_y, w = oadx_bomb_size.w, h = oadx_bomb_size.h},{time = 250}}},
			...
			{id = "oadxholds", timer = 70, filter = 1, blend = 2, offset = 3, offsets = {offset_consts.OFFSET_1_ID}, op = {op_consts.OP_3_ITEM_NUMBER_3}, dst = {{time = 0, x = oadx_bomb_x[8], y = oadx_bomb_y, w = oadx_bomb_size.w, h = oadx_bomb_size.h}}},
