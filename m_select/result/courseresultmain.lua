...
local header = {
	type = 15,
	name = "m_select_course_result (lua)",
	w = 1920,
	h = 1080,
	scene = 3600000,
	input = 500,
...
local function main()
	...
	local title_str = main_state.text(1003)
	...
	skin.text = {
		...
		{id = "title",	font = 0, size = 24, outlineColor = "000000ff", outlineWidth = 0.4, align = 1, constantText = title_str},
	}
	...
	if skin_config.option["リザルトの配置"] == RESULT_R then result_pos[1] = 1490 end
	
	local replay_1_pos	= {result_pos[1] + 13, result_pos[2] + 386}
	local replay_2_pos	= {result_pos[1] + 53, result_pos[2] + 386}
	local replay_3_pos	= {result_pos[1] + 93, result_pos[2] + 386}
	local replay_4_pos	= {result_pos[1] + 133, result_pos[2] + 386}
	local ir_pos		= {result_pos[1] + 13, result_pos[2] + 339}
	local ir_rank_pos	= {result_pos[1] + 73, result_pos[2] + 339}
	local ir_total_pos	= {result_pos[1] + 193, result_pos[2] + 339}
	local rate_pos		= {result_pos[1] + 113, result_pos[2] + 305}
	local rate_ad_pos	= {result_pos[1] + 181, result_pos[2] + 305}
	local clear_pos		= {result_pos[1] + 13, result_pos[2] + 281}
	local rank_pos		= {result_pos[1] + 241, result_pos[2] + 281}
	local diff_pos		= {result_pos[1] + 333, result_pos[2] + 281}
	local level_pos		= {result_pos[1] + 353, result_pos[2] + 281}
	local score_pos		= {result_pos[1] + 133, result_pos[2] + 237}
	local diffscore_pos	= {result_pos[1] + 273, result_pos[2] + 242}
	local combo_pos		= {result_pos[1] + 133, result_pos[2] + 202}
	local diffcombo_pos	= {result_pos[1] + 273, result_pos[2] + 207}
	local miss_pos		= {result_pos[1] + 133, result_pos[2] + 167}
	local diffmiss_pos	= {result_pos[1] + 273, result_pos[2] + 172}
	
	local jg_pos = {x = result_pos[1] + 73, y = {}}
	jg_pos.y[1] = result_pos[2] + 133
	for i = 2, 6, 1 do
		jg_pos.y[i] = jg_pos.y[i - 1] - 24
	end
	
	local timing_pos = {result_pos[1] + 270, result_pos[2] + 135}
	...
	local graph_pos = {x = {}, y = result_pos[2] + 31}
	...
	skin.destination = {
		...
		{id = "result_i", loop = dt[2],	dst = {{time = dt[1], x = result_pos[1] - 12, y = result_pos[2] - 12, w = 430, h = 397, acc = 2, a = 0},{time = dt[2], x = result_pos[1], y = result_pos[2], w = 406, h = 373, a = 255}}},
		...
		{id = "-110",			op = {GRAPH_ON}, loop = dt[2],				dst = {{time = dt[1], x = 454, y = 66, w = 1012, h = 120, a = 0},{time = dt[2], a = 192}}},
		...
		{id = "title",	dst = {{x = 960, y = 12, w = 24, h = 24}}},
