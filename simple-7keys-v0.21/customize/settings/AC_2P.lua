-- 描画設定
	...
	-- 曲進行度バーの表示位置
	songprogress_x = lanes_right_x - 12
	songprogress_y = lane_origin_y + songprogress_height
		
	-- スコアグラフの表示位置
	graph_x = lane_origin_x - 250
	graph_y = 360	
	
	-- EXスコアの表示位置
	exscore_x = graph_x + 78
	exscore_y = graph_y + 17
	
	-- スコア差の表示位置
	diffscore_x = graph_x + 78
	...
	-- タイミングビジュアライザー
	timingvisualizer_x = lane_origin_x + 138
