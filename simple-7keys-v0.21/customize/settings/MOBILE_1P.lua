-- 描画設定
	...
	lane_width = {149, 114, 149, 114, 149, 114, 149, 253}
				
	-- ノーツの横幅 {1,2,3,4,5,6,7,sc}
	note_width = {129, 94, 129, 94, 129, 94, 129, 233}
	
	-- ノーツの縦幅 {1,2,3,4,5,6,7,sc}
	note_height = {40,40,40,40,40,40,40,40}
	...
	-- レーンの表示位置(座標は左下が0,0)
	lane_origin_x = 960 - (lanes_width / 2)
	lane_origin_y = 210
	...
	-- 曲進行度バーのサイズ
	songprogress_height = 1080 - lane_origin_y - 160
	
	-- 曲進行度バーの表示位置
	songprogress_x = lane_origin_x - 58
	songprogress_y = lane_origin_y + songprogress_height + 80
		
	-- スコアグラフの表示位置
	graph_x = lanes_right_x + 56
	graph_y = 260	
	...
	-- BPMの表示位置
	bpm_x = gauge_x + gauge_width - 200
	bpm_y = gauge_y - 56
	
	-- タイトルの横幅
	title_width = gauge_width - 200
	...
	-- タイミングビジュアライザー
	timingvisualizer_x = lane_origin_x + lane_width[8] + lane_outline_px
