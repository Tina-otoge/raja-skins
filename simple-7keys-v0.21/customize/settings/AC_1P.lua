-- 描画設定
	...
	lane_order = {8,1,2,3,4,5,6,7}
	
	-- レーンの横幅 {1,2,3,4,5,6,7,sc}の順で値を入力してください
	lane_width = {51, 39, 51, 39, 51, 39, 51, 90}
				
	-- ノーツの横幅 {1,2,3,4,5,6,7,sc}
	note_width = {51, 39, 51, 39, 51, 39, 51, 90}
	
	-- ノーツの縦幅 {1,2,3,4,5,6,7,sc}
	note_height = {24,24,24,24,24,24,24,24}
	...
	-- 曲進行度バーの表示位置
	songprogress_x = lane_origin_x - 52
	songprogress_y = lane_origin_y + songprogress_height
		
	-- スコアグラフの表示位置
	graph_x = lanes_right_x + 29
	graph_y = 360	
	...
	-- グルーヴゲージの表示位置
	gauge_x = lane_origin_x - 18
	gauge_y = lane_origin_y - 192
	
	-- グルーヴゲージの目盛り数
	gauge_scale = 50
	
	-- グルーヴゲージのサイズ
	gauge_width = 9 * gauge_scale
	gauge_height = 32
	
	-- グルーヴゲージ数値の表示位置
	gauge_num_x = gauge_x + gauge_width - 112
	gauge_num_y = gauge_y + 42
	...
	-- タイトルの横幅
	title_width = lanes_width
	
	-- タイトルの表示位置
	title_x = lane_origin_x + (title_width / 2)
	title_y = 10
	...
	-- タイミングビジュアライザー
	timingvisualizer_x = gauge_x
	timingvisualizer_y = gauge_y + 42
	timingvisualizer_w = gauge_width - 138
	timingvisualizer_h = 32