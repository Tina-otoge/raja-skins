...
return{
	...
	OP_6_NAME = "OADX+判定文字を使用する Use OADX+ Judge",
		...
		OP_6_ITEM_NAME_2	= "4:3",
		OP_6_ITEM_NUMBER_2	= count(),
		OP_6_ITEM_NAME_3	= "16:9",
		OP_6_ITEM_NUMBER_3	= count(),
		
	OP_7_NAME = "OADX+ノーツを使用する Use OADX+ Notes",
		OP_7_ITEM_NAME_1	= "OFF",
		OP_7_ITEM_NUMBER_1	= count(),
		OP_7_ITEM_NAME_2	= "OADX+AC",
		OP_7_ITEM_NUMBER_2	= count(),
		OP_7_ITEM_NAME_3	= "OADX+ACW",
		OP_7_ITEM_NUMBER_3	= count(),
		OP_7_ITEM_NAME_4	= "OADX+CS",
		OP_7_ITEM_NUMBER_4	= count(),
		OP_7_ITEM_NAME_5	= "OADX+CSW",
		OP_7_ITEM_NUMBER_5	= count(),
	...
	DISP_14_NAME = "キャラクターを表示する Character",
		...
		-- 推定ランクを表示する Rank
		DISP_15_NUMBER_1 = count(),
		DISP_15_NUMBER_2 = count(),
		
		-- タイミングビジュアライザーを表示する timingvisualizer
		DISP_16_NUMBER_1 = count(),
		DISP_16_NUMBER_2 = count(),
